...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/admin/products/<?php echo htmlspecialchars( $product["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post" enctype="multipart/form-data"> <!-- enctype="multipart/form-data": é utilizado para funcionar o uload de um arquivos -->
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="vlweight">Peso (gramas)</label>
